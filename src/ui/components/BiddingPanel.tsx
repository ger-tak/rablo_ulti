...
interface BiddingPanelProps {
  ...
  highestBidder?: number | undefined;
...
export const BiddingPanel = ({
  ...
  const mustRaise = requireRaiseAfterTake && currentPlayer === highestBidder;
      ...
      <div className="panel-body">
        {bidAwaitingTalonDecision ? (
          ...
          <>
            <div className="pill-row">
              {nextBids.map((bid) => (
                <button
                  ...
                  disabled={mustRaise && bid.rank <= highestRank}
                >
                  {bid.name}
                </button>
              ))}
            ...
            <div className="panel-actions">
              <button type="button" className="primary" onClick={onPass} disabled={mustRaise}>
                Pass
              </button>
            </div>
          </>
